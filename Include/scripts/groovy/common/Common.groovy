...
public class Common {
	...
	def navigateToLoginPage() {
		...
		WebUI.callTestCase(findTestCase("Test Cases/common/The Login page is loaded successfully"), [:], FailureHandling.STOP_ON_FAILURE)
	}

	@Then("User is navigated to Home Page (.*)")
	def userIsNavigatedToHomePage(String result) {
